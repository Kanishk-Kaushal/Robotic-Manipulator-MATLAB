...
Basic_2R_arm = rigidBodyTree("DataFormat","column");
base = Basic_2R_arm.Base;
...
for i = 2:length(bodies) % Skip base. Iterate through adding bodies and joints.
            ...
            addBody(Basic_2R_arm,bodies{i},bodies{i-1}.Name)
            show(Basic_2R_arm,"Collisions","on","Frames","off");
            drawnow;
end
